                         ...
                         {users.map((user) => {
                            ...
                            return (
                               <tr key={user.id} className="group hover:bg-muted/10 dark:hover:bg-white/5 transition-colors">
                                  ...
                                  <td className="py-6 px-4 text-center"><span style={{ backgroundColor: roleData.color + '20', color: roleData.color }} className="px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border" style={{ borderColor: roleData.color + '30' }}>{roleData.name}</span></td>
